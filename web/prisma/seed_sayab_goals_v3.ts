...
async function main() {
    console.log('--- Cleaning up and Re-Seeding SAYAB Personal Goals (Web Schema) ---');
    ...
    const goalsData = [
        {
            ...
            objectives: [
                ...
                },
                {
                    ...
                    krs: [
                        { title: 'YouTube Subscribers', initialValue: 0, currentValue: 650, targetValue: 5000, unit: 'NUMBER' },
        ...
        },
        {
            ...
            objectives: [
                ...
                },
                {
                    ...
                    krs: [
                        { title: 'LinkedIn Followers/Connections', initialValue: 0, currentValue: 1900, targetValue: 10000, unit: 'NUMBER' },
        ...
        },
        {
            ...
            objectives: [
                ...
                },
                {
                    ...
                    krs: [
                        { title: 'Instagram Followers', initialValue: 0, currentValue: 200, targetValue: 2000, unit: 'NUMBER' },
    ...
    for (const goalData of goalsData) {
        ...
        for (const objData of goalData.objectives) {
            console.log(`  -> [CREATE] Objective: ${objData.title}`);
            ...
            for (const krData of objData.krs) {
                ...
                await (prisma as any).keyResult.create({
                    data: {
                        ...
                        unit: krData.unit,
                        objectiveId: objective.id, // using true Objective relation
                    }
                });
