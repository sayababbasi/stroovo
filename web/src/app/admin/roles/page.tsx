...
import AdminRolesList from '@/app/admin/teams/components/AdminRolesList';
import AdminRoleDetail from '@/app/admin/teams/components/AdminRoleDetail';
import AdminCreateRoleModal from '@/app/admin/teams/components/AdminCreateRoleModal';
...
export default function RolesPage() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', height: 'calc(100vh - 40px)', padding: '32px' }}>
