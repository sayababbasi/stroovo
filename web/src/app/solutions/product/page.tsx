...
export default function Page() {
  return (
    <ResourceHubLayout
      title="Product Teams"
      description="From roadmap to release, manage the entire product lifecycle."
    >
      <div className="max-w-4xl mx-auto py-20 px-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-xl mx-auto">
            We are currently building this page. Check back soon for exciting updates and detailed information about Product Teams.
          </p>
